...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			antiChangeNameOn: "✅|Turned on antichange name box chat",
			antiChangeNameOff: "✅|Turned off antichange name box chat",
			antiChangeNicknameOn: "✅|Turned on antichange nickname box chat",
			antiChangeNicknameOff: "✅|Turned off antichange nickname box chat",
			antiChangeThemeOn: "✅|Turned on antichange theme box chat",
			antiChangeThemeOff: "✅|Turned off antichange theme box chat",
			antiChangeEmojiOn: "✅|Turned on antichange emoji box chat",
			antiChangeEmojiOff: "✅|Turned off antichange emoji box chat",
