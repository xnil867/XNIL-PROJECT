module.exports = {
  config: {
    ...
    category: "Tutorial",
    guide: {
      en: "╔════ஜ۩۞۩ஜ═══╗\n\nTo use this command, simply type -hitotut.\n\n╚════ஜ۩۞۩ஜ═══╝",
    },
  },

  // onStart is a function that will be executed when the command is executed
  onStart: async function ({ api, args, message, event }) {
    const supportGroupId = "7504684502892535"; // ID of the support group
    ...
    if (participantIDs.includes(userID)) {
      ...
      api.sendMessage(
        "╔════ஜ۩۞۩ஜ═══╗\n\nYou are already in the Hitoshi Bot Tutorial group. If you didn't find it, please check your message requests or spam box.\n\n╚════ஜ۩۞۩ஜ═══╝",
        threadID
      );
    } else {
