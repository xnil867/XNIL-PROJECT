module.exports = {
	...
	antichangeinfobox: {
		...
		text: {
			antiChangeAvatarOn: "✅Turned on anti change avatar box chat",
			antiChangeAvatarOff: "✅Turned off anti change avatar box chat",
			missingAvt: "You have not set avatar for box chat",
			antiChangeNameOn: "✅Turned on anti change name box chat",
			antiChangeNameOff: "✅Turned off anti change name box chat",
			antiChangeThemeOn: "✅ Turned on anti change theme box chat",
			antiChangeThemeOff: "✅Turned off anti change theme box chat",
			antiChangeEmojiOn: "✅Turned on anti change emoji box chat",
			antiChangeEmojiOff: "✅Turned off anti change emoji box chat",
